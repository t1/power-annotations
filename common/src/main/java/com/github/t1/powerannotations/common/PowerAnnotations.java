...
public class PowerAnnotations {
    ...
    private void resolveStereotypes() {
        for (DotName stereotypeTypeName : jandex.allAnnotationNames()) {
            ...
            for (AnnotationInstance stereotypeAnnotationInstance : new ArrayList<>(getAnnotationInstances(stereotypeTypeName))) {
                ClassInfo stereotype = stereotypeAnnotationInstance.target().asClass();
                log.info("stereotype " + stereotype);
                for (AnnotationInstance stereotypeTargetAnnotationInstance : new ArrayList<>(getAnnotationInstances(stereotype.asClass().name()))) {
