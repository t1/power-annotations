...
public class DirectAnnotationsBehavior {
    ...
    @Nested class FieldAnnotations {
        ...
        @Test void shouldGetFieldAnnotation() {
    ...
    @Nested class MethodAnnotations {
        ...
        @Test void shouldGetMethodAnnotation() {
        ...
        @Test void shouldGetInterfaceMethodAnnotation() {
        ...
        @Test void shouldFailToGetAnnotationsFromUnknownMethodName() {
            Throwable throwable = catchThrowable(() -> Annotations.onMethod(SomeClassWithAnnotatedMethod.class, "bar", String.class));
        ...
        @Test void shouldFailToGetAnnotationsFromMethodWithTooFewArguments() {
            Throwable throwable = catchThrowable(() -> Annotations.onMethod(SomeClassWithAnnotatedMethod.class, "foo", String.class, int.class));
        ...
        @Test void shouldFailToGetAnnotationsFromMethodWithWrongArgumentType() {
            Throwable throwable = catchThrowable(() -> Annotations.onMethod(SomeClassWithAnnotatedMethod.class, "foo", int.class));
